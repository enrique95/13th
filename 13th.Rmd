...
Slavery has been a very controversial topic that even nowadays has ramifications in many different sectors and markets, be "legal" but out of public scrutiny, or illegal, yet scarcely prosecuted. This project aims to analyze the effect of slavery and its abolition with the 13th Amendment on the agriculture through the use of agricultural, demographic and geographical data. The goal of this project is to analyze just the economic background. From the ethical background there is not much discussion regarding this topic than what it is already stablished for years.
